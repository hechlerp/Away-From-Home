...
public class Max2D {
	...
	static public void DrawSpriteBatched(SpriteRenderer spriteRenderer, Vector2 pos, Vector2 size, float rot, float z = 0f) {
		DrawSpriteBatched(new VirtualSpriteRenderer(spriteRenderer), pos, size, rot, z);
    }
